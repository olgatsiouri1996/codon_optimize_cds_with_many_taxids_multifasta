...
# imput parameters
@Gooey(required_cols=3, program_name='codon optimize cds with many taxids multi-fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser()
    ...
    ap.add_argument("-opt","--optimized", required=True, widget='FileSaver', help="output multi-fasta file with optimized sequences")
